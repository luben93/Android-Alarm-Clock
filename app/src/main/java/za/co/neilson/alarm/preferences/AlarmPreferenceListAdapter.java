...
public class AlarmPreferenceListAdapter extends BaseAdapter implements Serializable {
	...
	private final String[] alarmDifficulties = {"SuperEasy","Easy","Medium","Hard"};//{Alarm.Difficulty.values().toString()};
...
//			public void run() {
				...
				Log.d("AlarmPrefereListAdapter", "Finished Loading " + alarmTones.length + " Ringtones.");
				alarmsCursor.close();
//				
//			}
//			
